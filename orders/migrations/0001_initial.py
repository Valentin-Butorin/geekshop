    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('STP', 'отправлено в обработку'), ('DN', 'завершено'), ('CNL', 'отменено'), ('FM', 'формируется'), ('PD', 'оплачено'), ('PRD', 'обработано')], default='FM', max_length=3)),
